...
[good first issue](https://github.com/andaluzcoin/andaluzcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/andaluzcoin/andaluzcoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the [Andaluzcoin Core PR Review Club](https://andaluzcoincore.reviews/).
...
Most communication about Andaluzcoin Core development happens on IRC, in the
`#andaluzcoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#andaluzcoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/andaluzcoin-core-dev/](https://www.erisian.com.au/andaluzcoin-core-dev/)
and [https://gnusha.org/andaluzcoin-core-dev/](https://gnusha.org/andaluzcoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/g/andaluzcoindev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/andaluzcoindev/](https://gnusha.org/pi/andaluzcoindev/).
...
For GUI-related issues or pull requests, the https://github.com/andaluzcoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/andaluzcoin/andaluzcoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to andaluzcoin-qt
...
fork of Andaluzcoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/andaluzcoin/andaluzcoin/blob/master/doc/translation_process.md)
...
projects such as libsecp256k1), and is not to be confused with overall Andaluzcoin
...
Patches that change Andaluzcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Andaluzcoin consensus, it must have been
...
https://github.com/andaluzcoin/andaluzcoin/pull/16189).

Also see the [backport.py script](
https://github.com/andaluzcoin-core/andaluzcoin-maintainer-tools#backport).
