# bash programmable completion for andaluzcoin-cli(1)
...
_andaluzcoin_cli() {
    ...
    local andaluzcoin_cli

    # save and use original argument to invoke andaluzcoin-cli for -help, help and RPC
    # as andaluzcoin-cli might not be in $PATH
    andaluzcoin_cli="$1"
...
complete -F _andaluzcoin_cli andaluzcoin-cli
