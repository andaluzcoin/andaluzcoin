...
# Extract options
function __fish_andaluzcoin_tx_get_options
...
# Extract commands
function __fish_andaluzcoin_tx_get_commands
...
# Add options
complete \
    --command andaluzcoin-tx \
    --condition "not __fish_andaluzcoin_seen_cmd (__fish_andaluzcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_andaluzcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command andaluzcoin-tx \
    --arguments "(__fish_andaluzcoin_tx_get_commands)" \
    --no-files
