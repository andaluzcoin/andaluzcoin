...
This means one can have an always-onandaluzcoind instance running, and another localandaluzcoind/bitcoin-qt instance which connects to this node and receives blocks from it.
