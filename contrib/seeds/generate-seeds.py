...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ANDALUZCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define ANDALUZCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the andaluzcoin network\n')
    ...
    g.write('#endif // ANDALUZCOIN_CHAINPARAMSSEEDS_H\n')
