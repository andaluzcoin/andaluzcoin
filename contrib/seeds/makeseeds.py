...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list ofandaluzcoin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multipleandaluzcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multipleandaluzcoin ports', file=sys.stderr)
