#!/usr/bin/env python3
# Copyright (c) 2020-2022 The Andaluzcoin Core developers
...
parser = argparse.ArgumentParser(description='Script to get coins from a faucet.', epilog='You may need to start with double-dash (--) when providing andaluzcoin-cli arguments.')
...
parser.add_argument('andaluzcoin_cli_args', nargs='*', help='Arguments to pass on to andaluzcoin-cli (default: -signet)')
...
def andaluzcoin_cli(rpc_command_and_params):
...
if args.faucet.lower() == DEFAULT_GLOBAL_FAUCET:
    ...
    curr_signet_hash = andaluzcoin_cli(['getblockhash', '1'])
...
if args.addr == '':
    ...
    args.addr = andaluzcoin_cli(['getnewaddress', 'faucet', 'bech32'])
