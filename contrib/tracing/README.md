...
```
$ python3 contrib/tracing/p2p_monitor.py $(pidofandaluzcoind)
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py $(pidofandaluzcoind)
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py $(pidofandaluzcoind)
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py $(pidofandaluzcoind)
```
