...
"""Example logging Andaluzcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/andaluzcoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[andaluzcoind_with_usdts])
