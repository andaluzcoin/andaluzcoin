#!/usr/bin/env python3
# Copyright (c) 2021 The Andaluzcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

""" Interactive andaluzcoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Andaluzcoin Core can enable. It uses BCC
...
def main(pid):
    peers = dict()
    print(f"Hooking into andaluzcoind with pid {pid}")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("USAGE:", sys.argv[0], "<pid of andaluzcoind>")
        exit()
