...
**When configuring Andaluzcoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Andaluzcoin Core:
...
variables will be set when generating the Andaluzcoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
