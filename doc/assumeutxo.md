...
Assumeutxo is a feature that allows fast bootstrapping of a validating andaluzcoind
instance.
...
```
$ andaluzcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ andaluzcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
