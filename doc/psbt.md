# PSBT Howto for Andaluzcoin Core
...
PSBT is an interchange format for Andaluzcoin transactions that are not fully signed
...
#### Multisig with multiple Andaluzcoin Core instances
...
Later, when *V* LUZ has been received on *Amulti*, and Bob and Carol want to
