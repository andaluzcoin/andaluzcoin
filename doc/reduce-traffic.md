...
By default, Andaluzcoin Core allows up to 125 connections to different peers, 11 of
...
limits are tiny. Keep in mind that andaluzcoin's trustless model works best if you are
