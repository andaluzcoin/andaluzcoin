Andaluzcoin Core version 0.10.3 is now available from:

  <https://andaluzcoin.org/bin/andaluzcoin-core-0.10.3/>
...
one was randomly violated by all deployed andaluzcoin software prior to
...
Andaluzcoin Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Andaluzcoinj has done so for a similar span of time.
Andaluzcoinjs and electrum have been more recently updated.
...
(see https://github.com/andaluzcoin/andaluzcoin/pull/6793, as well as the 0.11.0
