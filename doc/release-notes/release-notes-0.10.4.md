Andaluzcoin Core version 0.10.4 is now available from:

  <https://andaluzcoin.org/bin/andaluzcoin-core-0.10.4/>
...
- #6953 `43c2789` Split andaluzcoin-tx into its own package
- #6953 `dfe0d4d` Include andaluzcoin-tx binary on Debian/Ubuntu
