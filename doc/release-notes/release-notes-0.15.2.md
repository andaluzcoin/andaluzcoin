Andaluzcoin Core version *0.15.2* is now available from:

  <https://andaluzcoincore.org/bin/andaluzcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in andaluzcoin-tx (TheBlueMatt)
