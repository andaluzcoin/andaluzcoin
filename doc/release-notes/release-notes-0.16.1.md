Andaluzcoin Core version 0.16.1 is now available from:

  <https://andaluzcoincore.org/bin/andaluzcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting andaluzcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure andaluzcoind processes are cleaned up when tests end (sdaftuar)
