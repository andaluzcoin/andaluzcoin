Andaluzcoin Core version 0.16.3 is now available from:

  <https://andaluzcoincore.org/bin/andaluzcoin-core-0.16.3/>
...
been discovered in Andaluzcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` andaluzcoinconsensus: invalid flags error should be set to `andaluzcoinconsensus_err` (afk11)
