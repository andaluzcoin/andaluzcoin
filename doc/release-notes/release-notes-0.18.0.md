...
- `generate` is deprecated and will be fully removed in a subsequent
  ...
  in this version, restartandaluzcoind with the `-deprecatedrpc=generate`
...
- #14162 Also log and print messages or questions likeandaluzcoind (MarcoFalke)
...
- #13953 Fix deprecation inandaluzcoin-util-test.py (isghe)
...
- #12246 Bugfix: Only runandaluzcoin-tx tests whenandaluzcoin-tx is enabled (luke-jr)
...
- #14186andaluzcoin-cli: don't translate command line options (HashUnlimited)
...
- #12255 Updateandaluzcoin.service to conform to init.md (dongcarl)
...
- #15765 correctandaluzcoinconsensus_version in shared-libraries.md (fanquake)
- #15792 describe onlynet option in doc/tor.md (jonatack)
- #15802 mention creating application supportandaluzcoin folder on OSX (JimmyMow)
