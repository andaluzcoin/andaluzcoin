...
- #15639andaluzcoin-wallet tool: Drop libbitcoin_server.a dependency (ryanofsky)
...
- #15896 feature_filelock, interface_bitcoin_cli: Use PACKAGE_NAME in messages rather than hardcoding Andaluzcoin Core (luke-jr)
