...
- #15639 andaluzcoin-wallet tool: Drop libandaluzcoin_server.a dependency (ryanofsky)
...
- #16366 init: Use InitError for all errors in andaluzcoind/qt (MarcoFalke)
...
- #16258 [MSVC]: Create the config.ini as part of andaluzcoind build (NicolasDorier)
...
- #16441 remove qt libjpeg check from andaluzcoin_qt.m4 (fanquake)
...
- #16489 log: harmonize andaluzcoind logging (jonatack)
...
- #15513 add "sections" info to example andaluzcoin.conf (fanquake)
...
- #16080 build/doc: update andaluzcoin_config.h packages, release process (jonatack)
...
- #16448 add note on precedence of options in andaluzcoin.conf (fanquake)
...
- #16621 add default andaluzcoin.conf locations (GChuf)
...
- #16863 Add a missing closing parenthesis in the andaluzcoin-wallet's help (darosior)
