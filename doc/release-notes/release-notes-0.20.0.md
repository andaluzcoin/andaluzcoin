...
#### Removal of BIP61 reject network messages from Andaluzcoin Core

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Andaluzcoin Core version 0.18.0.
...
- Testing or debugging of implementations of the Andaluzcoin P2P network protocol
  should be done by inspecting the log messages that are produced by a recent
  version of Andaluzcoin Core. Andaluzcoin Core logs debug messages
...
- OpenSSL is no longer used by Andaluzcoin Core.  (#17265)

- BIP70 support has been fully removed from Andaluzcoin Core. The
...
- All custom settings configured when Andaluzcoin Core starts are now
...
- The "Start Andaluzcoin Core on system login" option has been removed on macOS.
  (#17567)
...
- #18702 Fix ASLR for andaluzcoin-cli on Windows (fanquake)
...
- #17206 Add testcase to simulate andaluzcoin schema in leveldb (adamjonas)
...
- #17330 Add `shrinkdebugfile=0` to regtest andaluzcoin.conf (sdaftuar)
...
- #18430 ci: Only clone andaluzcoin-core/qa-assets when fuzzing (MarcoFalke)
...
- #16983 Add detailed info about Andaluzcoin Core files (hebasto)
...
- #17119 Fix broken andaluzcoin-cli examples (andrewtoth)
...
- #17503 Remove bitness from andaluzcoin-qt help message and manpage (laanwj)
...
- #17648 Rename wallet-tool references to andaluzcoin-wallet (hel-o)
...
- #16115 On andaluzcoind startup, write config args to debug.log (LarryRuane)
...
- #17650 util: Remove unwanted fields from andaluzcoin-cli -getinfo (malevolent)
