...
Drag and drop support forandaluzcoin: URIs on web pages.
...
signmessage/verifymessage : new RPC commands to sign a message with one of your private keys or verify that a message signed by the private key associated with aandaluzcoin address.
