...
Coreandaluzcoin handling and blockchain database
...
* Ensure a changedandaluzcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP forandaluzcoin-qt.exe
* (Windows only): add meta-data toandaluzcoin-qt.exe (e.g. description)
...
* Bash programmable completion forandaluzcoind(1)
