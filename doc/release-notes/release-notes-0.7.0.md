...
We recommend that everybody running prior versions of andaluzcoind/Andaluzcoin-Qt
...
Core andaluzcoin handling and blockchain database
...
* Ensure a changed andaluzcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for andaluzcoin-qt.exe
* (Windows only): add meta-data to andaluzcoin-qt.exe (e.g. description)
...
* Bash programmable completion for andaluzcoind(1)
