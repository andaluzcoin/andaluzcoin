Andaluzcoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/andaluzcoin/files/Andaluzcoin/andaluzcoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Andaluzcoin-Qt to crash on Windows when exiting.
