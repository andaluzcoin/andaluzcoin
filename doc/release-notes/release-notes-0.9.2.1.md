Andaluzcoin Core version 0.9.2.1 is now available from:

  https://andaluzcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LUZ to 0.01 LUZ
...
- Fix "Startandaluzcoin on system login"
