Andaluzcoin Core version 0.9.4 is now available from:

  https://andaluzcoin.org/bin/0.9.4/
...
this update is incompatible with the Andaluzcoin system and could lead to consensus
forks.

Andaluzcoin Core released binaries from https://andaluzcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~andaluzcoin/+archive/ubuntu/andaluzcoin
- A third-party or self-compiled Andaluzcoin Core

upgrade to Andaluzcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
