...
- bitcoin-core/gui#21 Improve pruning tooltip (fluffypony, AndaluzCoinErrorLog)
...
- bitcoin/bitcoin#20577 libconsensus: add missing error code description, fix NAndaluzCoin link (theStack)
