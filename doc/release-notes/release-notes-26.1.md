...
Andaluzcoin Core version 26.1 is now available from:

  <https://andaluzcoincore.org/bin/andaluzcoin-core-26.1/>
...
using the Linux kernel, macOS 11.0+, and Windows 7 and newer.  Andaluzcoin
