...
#ifndef ANDALUZCOIN_ADDRMAN_IMPL_H
#define ANDALUZCOIN_ADDRMAN_IMPL_H
 ...
 * see https://andaluzcoincore.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // ANDALUZCOIN_ADDRMAN_IMPL_H
