...
#ifndef ANDALUZCOIN_ARITH_UINT256_H
#define ANDALUZCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Andaluzcoin only uses this "compact" format for encoding difficulty
...
#endif // ANDALUZCOIN_ARITH_UINT256_H
