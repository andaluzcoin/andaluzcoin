...
#ifndef ANDALUZCOIN_CHAINPARAMSBASE_H
#define ANDALUZCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between andaluzcoin-cli and andaluzcoind)
...
#endif // ANDALUZCOIN_CHAINPARAMSBASE_H
