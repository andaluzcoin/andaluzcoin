...
#error Client version information missing: version is not defined by andaluzcoin-build-config.h or in any other way
#endif
...
/**
 * andaluzcoind-res.rc includes this file, but it cannot cope with real c++ code.
