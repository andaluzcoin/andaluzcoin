...
#ifndef ANDALUZCOIN_COMMON_ARGS_H
#define ANDALUZCOIN_COMMON_ARGS_H
...
extern const char * const ANDALUZCOIN_CONF_FILENAME;
extern const char * const ANDALUZCOIN_SETTINGS_FILENAME;
...
#endif // ANDALUZCOIN_COMMON_ARGS_H
