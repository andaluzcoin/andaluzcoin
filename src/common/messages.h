...
// Copyright (c) 2009-2020 The Andaluzcoin Core developers
...
#ifndef ANDALUZCOIN_COMMON_MESSAGES_H
#define ANDALUZCOIN_COMMON_MESSAGES_H
...
#endif // ANDALUZCOIN_COMMON_MESSAGES_H
