...
#ifndef ANDALUZCOIN_COMMON_SIGNMESSAGE_H
#define ANDALUZCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's andaluzcoin address, it must refer to a public key.
...
#endif // ANDALUZCOIN_COMMON_SIGNMESSAGE_H
