// Copyright (c) 2015-2018 The Andaluzcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ANDALUZCOIN_CORE_MEMUSAGE_H
#define ANDALUZCOIN_CORE_MEMUSAGE_H
...
#endif // ANDALUZCOIN_CORE_MEMUSAGE_H
