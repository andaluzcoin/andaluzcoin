...
#ifndef ANDALUZCOIN_HEADERSSYNC_H
#define ANDALUZCOIN_HEADERSSYNC_H
 ...
 *
 * The Andaluzcoin protocol does not offer an easy way to determine the work on a
...
#endif // ANDALUZCOIN_HEADERSSYNC_H
