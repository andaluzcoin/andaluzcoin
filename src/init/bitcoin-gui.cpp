...
namespace init {
namespace {
const char* EXE_NAME = "andaluzcoin-gui";
...
public:
    ...
    // andaluzcoin-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // andaluzcoin-node accepts the option, and andaluzcoin-gui accepts all andaluzcoin-node
