...
#ifndef ANDALUZCOIN_INTERFACES_INIT_H
#define ANDALUZCOIN_INTERFACES_INIT_H
...
//! (andaluzcoin-gui, andaluzcoin-node, andaluzcoin-wallet, andaluzcoind, andaluzcoin-qt) and each
...
#endif // ANDALUZCOIN_INTERFACES_INIT_H
