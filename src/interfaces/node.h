...
#ifndef ANDALUZCOIN_INTERFACES_NODE_H
#define ANDALUZCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a andaluzcoin node (andaluzcoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or andaluzcoin.conf.
...
#endif // ANDALUZCOIN_INTERFACES_NODE_H
