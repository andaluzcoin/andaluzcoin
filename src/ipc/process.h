...
#ifndef ANDALUZCOIN_IPC_PROCESS_H
#define ANDALUZCOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning andaluzcoin processes and serving requests
...
#endif // ANDALUZCOIN_IPC_PROCESS_H
