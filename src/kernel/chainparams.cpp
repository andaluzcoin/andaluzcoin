...
public:
    CMainParams() {
        ...
        // New chain: do not inherit Bitcoin historical exceptions/heights
         ...
         */
        // Network magic + default port (mainnet)
        ...
        // KEEP BITCOIN WIF + xpub/xprv (mainnet)
        base58Prefixes[SECRET_KEY]      = std::vector<unsigned char>(1, 128);               // 0x80 -> 5/K/L
