...
public:
    CMainParams() {
        ...
        // v0.1 policy: treat buried deployments as active from height 1.
        ...
        // Taproot: always active for Andaluzcoin mainnet v0.1
        ...
        // New chain: no historical assumptions yet.
        ...
        const char* pszTimestamp = "Andaluzcoin 30/Jan/2026 Viva Al-Andalus";
        ...
        assert(consensus.hashGenesisBlock == uint256{"000000f7dca7651a1397fd0bc99b2a456dbb2d23470834b6290aadec4b46d15c"});
        ...
        // Provisional v31 header-sync tuning. Regenerate after Andaluzcoin
        // establishes a nonzero nMinimumChainWork checkpoint.
