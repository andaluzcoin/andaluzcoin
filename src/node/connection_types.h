...
#ifndef ANDALUZCOIN_NODE_CONNECTION_TYPES_H
#define ANDALUZCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/andaluzcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Andaluzcoin’s Peer-to-Peer Network")
...
#endif // ANDALUZCOIN_NODE_CONNECTION_TYPES_H
