...
#ifndef ANDALUZCOIN_POLICY_FEERATE_H
#define ANDALUZCOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "LUZ"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    LUZ_KVB,      //!< Use LUZ/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::LUZ_KVB) const;
...
#endif // ANDALUZCOIN_POLICY_FEERATE_H
