This directory contains the source code for the Andaluzcoin Core graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
- (Deprecated) Used to process BIP21 payment URI requests. Also handles URI-based application switching (e.g. when following a andaluzcoin:... link from a browser).
...
* `andaluzcoinunits.(h/cpp)`: BTC / mBTC / etc. handling
* `callback.h`
