...
#ifndef ANDALUZCOIN_QT_ANDALUZCOINGUI_H
#define ANDALUZCOIN_QT_ANDALUZCOINGUI_H
...
/**
  Andaluzcoin GUI main class. This class represents the main window of the Andaluzcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AndaluzcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AndaluzcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~AndaluzcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a andaluzcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, AndaluzcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Andaluzcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(AndaluzcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // ANDALUZCOIN_QT_ANDALUZCOINGUI_H
