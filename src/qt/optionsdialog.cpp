      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->andaluzcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->andaluzcoinAtStartup);
    ...
    ui->andaluzcoinAtStartup->setToolTip(ui->andaluzcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->andaluzcoinAtStartup->setText(ui->andaluzcoinAtStartup->text().arg(CLIENT_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->andaluzcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSLUZontrols);
