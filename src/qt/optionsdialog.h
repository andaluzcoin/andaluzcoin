...
#ifndef ANDALUZCOIN_QT_OPTIONSDIALOG_H
#define ANDALUZCOIN_QT_OPTIONSDIALOG_H
...
private Q_SLOTS:
    ...
    void on_openAndaluzcoinConfButton_clicked();
...
#endif // ANDALUZCOIN_QT_OPTIONSDIALOG_H
