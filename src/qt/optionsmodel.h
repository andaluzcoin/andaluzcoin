...
/** Interface from Qt to configuration data structure for AndaluzCoin client.
...
public:
    ...
    bool getEnablePSLUZontrols() const { return m_enable_psbt_controls; }
...
Q_SIGNALS:
    void displayUnitChanged(AndaluzCoinUnit unit);
