...
#ifndef ANDALUZCOIN_QT_PAYMENTSERVER_H
#define ANDALUZCOIN_QT_PAYMENTSERVER_H
...
extern const QString ANDALUZCOIN_IPC_PREFIX;
...
#endif // ANDALUZCOIN_QT_PAYMENTSERVER_H
