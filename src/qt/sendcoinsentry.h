...
#ifndef ANDALUZCOIN_QT_SENDCOINSENTRY_H
#define ANDALUZCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending andaluzcoins.
 */
...
#endif // ANDALUZCOIN_QT_SENDCOINSENTRY_H
