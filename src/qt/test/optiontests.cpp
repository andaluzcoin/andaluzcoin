...
{
    // Test regression https://github.com/andaluzcoin/andaluzcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/andaluzcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/andaluzcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Andaluzcoin/Andaluzcoin-Qt.conf and all else left as default,
    // andaluzcoin-qt should set both -listen and -listenonion to false and start successfully.
