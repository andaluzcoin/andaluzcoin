...
#ifndef ANDALUZCOIN_QT_WALLETMODEL_H
#define ANDALUZCOIN_QT_WALLETMODEL_H
...
/** Interface to Andaluzcoin wallet from Qt view code. */
...
#endif // ANDALUZCOIN_QT_WALLETMODEL_H
