...
#ifndef ANDALUZCOIN_RPC_PROTOCOL_H
#define ANDALUZCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in andaluzcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Andaluzcoin is not connected
...
#endif // ANDALUZCOIN_RPC_PROTOCOL_H
