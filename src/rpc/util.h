...
#ifndef ANDALUZCOIN_RPC_UTIL_H
#define ANDALUZCOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting LUZ/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1LUZ/kvB.
 */
