...
#ifndef ANDALUZCOIN_SCRIPT_MINISCRIPT_H
#define ANDALUZCOIN_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a andaluzcoin script
...
#endif // ANDALUZCOIN_SCRIPT_MINISCRIPT_H
