...
#ifndef ANDALUZCOIN_SCRIPT_SCRIPT_H
#define ANDALUZCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Andaluzcoin always counted CHECKMULTISIGs
...
#endif // ANDALUZCOIN_SCRIPT_SCRIPT_H
