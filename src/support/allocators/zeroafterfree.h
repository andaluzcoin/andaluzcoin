...
#ifndef ANDALUZCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define ANDALUZCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // ANDALUZCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
