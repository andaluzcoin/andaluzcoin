// Copyright (c) 2016-2018 The Andaluzcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ANDALUZCOIN_SUPPORT_EVENTS_H
#define ANDALUZCOIN_SUPPORT_EVENTS_H
...
#endif // ANDALUZCOIN_SUPPORT_EVENTS_H
