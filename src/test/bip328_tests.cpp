...
BOOST_AUTO_TEST_CASE(valid_keys)
{
    ...
    std::vector<BIP328TestVector> test_vectors = {
        // Test vector 0
        {
            ...
            .expected_aggregate_xpub = "zpub6jftahH18ngZxUV8QmUq3AR2K2XpEFSqN9dP6QLY1FGUqRyWtXWv9KrDyw9VG47kooThuHXYt4Hz8BZURguN5YjvKgaDHjweeRwLs787unw"
        },
        // Test vector 1
        {
            .pubkeys = {
            ...
            .expected_aggregate_xpub = "zpub6jftahH18ngZxUV8QmUq3AR2K2XpEFSqN9dP6QLY1FGUqRyWtXWv9KrDyufFT4cawkAh17pbxYQx3EpNbQq8ThWPc5oZc56cT5sXEzXb2sh"
        },
        // Test vector 2
        {
            .pubkeys = {
            ...
            .expected_aggregate_xpub = "zpub6jftahH18ngZxUV8QmUq3AR2K2XpEFSqN9dP6QLY1FGUqRyWtXWv9KrDytqkZN8pgckgSKGGp4eZrPR2f8CsyhfoQe8C7bkqTSipEpMUyoT"
        }
    };
