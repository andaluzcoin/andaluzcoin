...
void IpcSocketTest(const fs::path& datadir)
{
    ...
    //   Address 'unix' path '"/tmp/test_common_AndaluzCoin Core/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff/test_bitcoin.sock"' exceeded maximum socket path length
