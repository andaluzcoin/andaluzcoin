...
{
    BOOST_TEST_MESSAGE("Skipping Bitcoin mainnet kernel block-vector test on Andaluzcoin. "
                       "This test uses Bitcoin mainnet block data and is not valid for "
                       "Andaluzcoin's custom mainnet genesis/history.");
}
