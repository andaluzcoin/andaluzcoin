...
{
    BOOST_CHECK(TestSplitHost("www.andaluzcoincore.org", "www.andaluzcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.andaluzcoincore.org]", "www.andaluzcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.andaluzcoincore.org:80", "www.andaluzcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.andaluzcoincore.org]:80", "www.andaluzcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.andaluzcoincore.org:65536", "www.andaluzcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.andaluzcoincore.org:0", "www.andaluzcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.andaluzcoincore.org:", "www.andaluzcoincore.org:", 0, false));
}
