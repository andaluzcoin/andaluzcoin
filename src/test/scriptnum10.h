...
#ifndef ANDALUZCOIN_TEST_SCRIPTNUM10_H
#define ANDALUZCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Andaluzcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ANDALUZCOIN_TEST_SCRIPTNUM10_H
