// Copyright (c) 2015-2021 The Andaluzcoin Core developers
 ...
 */
#ifndef ANDALUZCOIN_TORCONTROL_H
#define ANDALUZCOIN_TORCONTROL_H
...
/****** Andaluzcoin specific TorController implementation ********/
...
#endif // ANDALUZCOIN_TORCONTROL_H
