...
// Copyright (c) 2009-2023 The Andaluzcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ANDALUZCOIN_UTIL_FS_HELPERS_H
#define ANDALUZCOIN_UTIL_FS_HELPERS_H
...
#endif // ANDALUZCOIN_UTIL_FS_HELPERS_H
