// Copyright (c) 2018-2019 The Andaluzcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ANDALUZCOIN_UTIL_THREADNAMES_H
#define ANDALUZCOIN_UTIL_THREADNAMES_H
...
#endif // ANDALUZCOIN_UTIL_THREADNAMES_H
