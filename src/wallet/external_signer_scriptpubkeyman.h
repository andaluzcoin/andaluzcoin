...
#ifndef ANDALUZCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ANDALUZCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ANDALUZCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
