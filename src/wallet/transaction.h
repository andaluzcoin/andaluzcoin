...
#ifndef ANDALUZCOIN_WALLET_TRANSACTION_H
#define ANDALUZCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this andaluzcoin node, and set to 0 for transactions that were created
...
#endif // ANDALUZCOIN_WALLET_TRANSACTION_H
