...
#ifndef ANDALUZCOIN_WALLET_WALLET_H
#define ANDALUZCOIN_WALLET_WALLET_H
...
public:
     ...
     * andaluzcoin-wallet tool code or by wallet migration code. If this is called
...
#endif // ANDALUZCOIN_WALLET_WALLET_H
