...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AndaluzcoinTestFramework
    pass


class ExampleTest(AndaluzcoinTestFramework):
    # Each functional test is a subclass of the AndaluzcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AndaluzcoinTestFramework class so other tests can use it."""
