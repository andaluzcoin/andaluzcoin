#!/usr/bin/env python3
# Copyright (c) 2017-present The Andaluzcoin Core developers
...
class ConfArgsTest(AndaluzcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        # Check that startup fails if conf= is set in andaluzcoin.conf or in an included conf file
    ...
    def test_ignored_conf(self):
        self.log.info('Test error is triggered when the datadir in use contains a andaluzcoin.conf file that would be ignored '
        ...
        # the same andaluzcoin.conf that would be loaded anyway does not trigger an
        # error.
    ...
    def test_ignored_default_conf(self):
        ...
        self.log.info('Test error is triggered when andaluzcoin.conf in the default data directory sets another datadir '
                      'and it contains a different andaluzcoin.conf file that would be ignored')
