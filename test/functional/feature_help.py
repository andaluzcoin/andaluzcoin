...
"""Verify that starting andaluzcoin with -h works as expected."""
...
class HelpTest(AndaluzcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start andaluzcoin with -h for help text")
        ...
        self.log.info("Start andaluzcoin with -version for version information")
        ...
        self.log.info("Start andaluzcoind with -fakearg to make sure it does not start")
