...
class HelpTest(AndaluzCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Startandaluzcoin with -h for help text")
        ...
        self.log.info("Startandaluzcoin with -version for version information")
        ...
        self.log.info("Startandaluzcoind with -fakearg to make sure it does not start")
