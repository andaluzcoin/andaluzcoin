...
class TestAndaluzcoinCli(AndaluzcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Prevent andaluzcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and andaluzcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and andaluzcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test andaluzcoin-cli -generate with -rpcwallet in multiwallet mode.
