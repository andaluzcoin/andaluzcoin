...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/andaluzcoin/andaluzcoin/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(AndaluzcoinTestFramework):
