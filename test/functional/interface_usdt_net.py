...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/andaluzcoin/andaluzcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(AndaluzcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our andaluzcoind node")
