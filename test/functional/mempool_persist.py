...
By default, andaluzcoind will dump mempool on shutdown and
...
class MempoolPersistTest(AndaluzcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent andaluzcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
