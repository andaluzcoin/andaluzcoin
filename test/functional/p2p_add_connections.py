...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The andaluzcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(AndaluzcoinTestFramework):
    ...
    def run_test(self):
        ...
        # andaluzcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that andaluzcoind sends its own version prior to processing
