...
# TestP2PConn: A peer we use to send messages to andaluzcoind, and store responses.
...
class CompactBlocksTest(AndaluzcoinTestFramework):
    ...
    # This test actually causes andaluzcoind to (reasonably!) disconnect us, so do this last.
    ...
    # andaluzcoind's choice of nonce.
    ...
    # Test that andaluzcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for andaluzcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # andaluzcoind will not send blocktxn responses for blocks whose height is
