...
# TestP2PConn: A peer we use to send messages toandaluzcoind, and store responses.
...
class CompactBlocksTest(AndaluzcoinTestFramework):
    ...
    # This test actually causesandaluzcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test thatandaluzcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible forandaluzcoind to be smart enough to know we're
