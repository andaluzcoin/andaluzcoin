...
Verify that a andaluzcoind node can use an external signer command.
...
class RPCSignerTest(AndaluzcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart andaluzcoind with -signer=<cmd>',
