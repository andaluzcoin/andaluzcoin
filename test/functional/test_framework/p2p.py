...
"""Test objects for interacting with aandaluzcoind node over the p2p protocol.

The P2PInterface objects interact with theandaluzcoind nodes under test using the
