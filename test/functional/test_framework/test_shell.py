...
class TestShell:
    """Wrapper Class for AndaluzcoinTestFramework.

    The TestShell class extends the AndaluzcoinTestFramework
    ...
    class __TestShell(AndaluzcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AndaluzcoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # AndaluzcoinTestFramework instances are supposed to be constructed with the path
