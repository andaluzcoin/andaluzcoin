...
BASE_SCRIPTS = [
    ...
    'wallet_andaluz_encryption_identity.py',
    'wallet_andaluz_passphrase_change_identity.py',
    'wallet_andaluz_message_signing_identity.py',
    'wallet_andaluz_encrypted_send_identity.py',
    'wallet_andaluz_change_address_identity.py',
    'wallet_andaluz_transaction_history_identity.py',
    'wallet_andaluz_balance_accounting_identity.py',
    'wallet_andaluz_receive_accounting_identity.py',
    'wallet_andaluz_sendmany_accounting_identity.py',
    ...
    'wallet_andaluz_watchonly_spend_restriction_identity.py',
    ...
    'wallet_andaluz_coin_selection_identity.py',
    ...
    'wallet_andaluz_dust_change_identity.py',
    'wallet_andaluz_send_rpc_identity.py',
    'wallet_andaluz_sendall_identity.py',
    ...
    'wallet_andaluz_send_locktime_identity.py',
    ...
    'mining_andaluz_generateblock_identity.py',
