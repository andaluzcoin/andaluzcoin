...
"""Verify Andaluzcoin wallet multisig spend identity."""
...
class AndaluzWalletMultisigSpendIdentityTest(BitcoinTestFramework):
    ...
    def run_test(self):
        miner_wallet_name = "andaluz_multisig_miner"
        sender_wallet_name = "andaluz_multisig_sender"
        signer_one_wallet_name = "andaluz_multisig_signer_one"
        signer_two_wallet_name = "andaluz_multisig_signer_two"
        multisig_wallet_name = "andaluz_multisig_coordinator"
        receiver_wallet_name = "andaluz_multisig_receiver"
        ...
        signer_one_address = signer_one.getnewaddress("andaluz-multisig-signer-one", "bech32")
        signer_two_address = signer_two.getnewaddress("andaluz-multisig-signer-two", "bech32")
        ...
        self.log.info("Sending confirmed Andaluzcoin payment to multisig address")
        ...
        self.log.info("Checking multisig wallet balance, history, and UTXO detection")
        ...
        self.log.info("Creating PSBT spend from multisig UTXO")
        receiver_address = receiver.getnewaddress("andaluz-multisig-receiver", "bech32")
        ...
        self.log.info("Broadcasting finalized Andaluzcoin multisig spend")
        ...
        self.log.info("Checking receiver got confirmed Andaluzcoin from multisig spend")
        self.wait_until(
...
if __name__ == "__main__":
    AndaluzWalletMultisigSpendIdentityTest(__file__).main()
