...
class TxnMallTest(AndaluzCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 LUZ:
        ...
        # First: use raw transaction API to send 1240 LUZ to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 LUZ coin each
        ...
        # Node0's balance should be starting balance, plus 50LUZ for another
        ...
        # Node0's total balance should be starting balance, plus 100LUZ for
