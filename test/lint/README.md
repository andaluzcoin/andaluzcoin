...
```sh
DOCKER_BUILDKIT=1 docker build -tandaluzcoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/andaluzcoin -itandaluzcoin-linter
```
...
* for `src/leveldb`: https://github.com/andaluzcoin-core/leveldb-subtree.git (branchandaluzcoin-fork)
* for `src/crypto/ctaes`: https://github.com/andaluzcoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/andaluzcoin-core/crc32c-subtree.git (branchandaluzcoin-fork)
