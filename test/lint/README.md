...
```sh
DOCKER_BUILDKIT=1 docker build -t andaluzcoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/andaluzcoin -it andaluzcoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/andaluzcoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/andaluzcoin-core/leveldb-subtree.git (branch andaluzcoin-fork)
* for `src/crypto/ctaes`: https://github.com/andaluzcoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/andaluzcoin-core/crc32c-subtree.git (branch andaluzcoin-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/andaluzcoin-core/secp256k1.git
```
