...
#
# Be aware thatandaluzcoind andandaluzcoin-qt differ in terms of localization: Qt
# opts in to POSIX localization by running setlocale(LC_ALL, "") on startup,
# whereas no such call is made inandaluzcoind.
#
...
# thus ignored.
#
# This results in situations whereandaluzcoind is guaranteed to be running
# with the classic locale ("C") whereas the locale ofandaluzcoin-qt will vary
# depending on the user's environment variables.
#
# An example: Assuming the environment variable LC_ALL=de_DE then the
# call std::to_string(1.23) will return "1.230000" inandaluzcoind but
# "1,230000" inandaluzcoin-qt.
#
